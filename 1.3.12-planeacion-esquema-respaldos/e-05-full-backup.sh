...
path_to_backup_script=/unam/bda/proyecto-final/dba-final-project-anz-dnh/1.3.12-planeacion-esquema-respaldos/e-05a-full-backup.sh
...
echo "0 2 * * * $path_to_backup_script > $mejor_ruta_para_guardar_log/full_backup.log 2>&1" >> /var/spool/cron/crontabs/root
