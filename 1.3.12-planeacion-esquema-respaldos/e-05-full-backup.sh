...
echo "Programando respaldo de script $path_to_backup_script para ejecutarse semanalmente a las 02:00am horas y guardar log en $mejor_ruta_para_guardar_log/full_backup.log..."
echo "0 2 * * 0 $path_to_weekly_backup_script > $mejor_ruta_para_guardar_log/full_backup.log" >> /var/spool/cron/crontabs/root"
