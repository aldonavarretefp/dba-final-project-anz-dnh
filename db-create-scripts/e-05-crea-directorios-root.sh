...
#--TODO
for i in $(seq 1 3); do
  if [ -d "/unam/diplo-bd/disks/d0${i}/app/oracle/oradata/${ORACLE_SID^^}" ]; then
...
rm -f /unam/diplo-bd/disks/d0*/app/oracle/oradata/${ORACLE_SID^^}/control*.ctl
rm -f /unam/diplo-bd/disks/d0*/app/oracle/oradata/${ORACLE_SID^^}/redo*.log
#TODO--
...
ls -l /unam/diplo-bd/disks/d0*/app/oracle/oradata