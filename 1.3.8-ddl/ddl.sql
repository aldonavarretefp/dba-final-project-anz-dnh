...
DROP TABLE IF EXISTS DISH_TYPE CASCADE CONSTRAINT;
...
DROP TABLE IF EXISTS DISH CASCADE CONSTRAINT;
CREATE TABLE DISH (
    DISH_ID              NUMBER NOT NULL,
    DISH_NAME            VARCHAR2(20) NOT NULL,
    DISH_CATEGORY        VARCHAR2(20) NOT NULL CHECK (DISH_CATEGORY IN ('BREAKFAST', 'LUNCH', 'DINNER')),
...
DROP TABLE IF EXISTS DISH_GALLERY CASCADE CONSTRAINT;
...
DROP TABLE IF EXISTS DISH_PRICE_HISTORY CASCADE CONSTRAINT;
...
DROP TABLE IF EXISTS DISH_REVIEW CASCADE CONSTRAINT;
...
DROP TABLE IF EXISTS ORDER_STATUS CASCADE CONSTRAINT;
CREATE TABLE ORDER_STATUS (
    ORDER_STATUS_ID      NUMBER NOT NULL,
    ORDER_STATUS         VARCHAR2(20) NOT NULL CHECK (ORDER_STATUS IN ('REGISTERED', 'PAID', 'IN_PROCESS', 'SENT_TO_DEALER', 'DELIVERED', 'CANCELED', 'REJECTED')),
...
DROP TABLE IF EXISTS ORDERVF CASCADE CONSTRAINT;
CREATE TABLE ORDERVF (
    ...
    USING INDEX (
        CREATE UNIQUE INDEX ORDER_PK ON ORDERVF (ORDER_ID)
        TABLESPACE TS_ORDERS_INDEX
    ),
...
CREATE INDEX IDX_ORDER_CLIENT_ID ON ORDERVF (ORDER_CLIENT_ID) TABLESPACE TS_ORDERS_INDEX;
CREATE INDEX IDX_ORDER_DEALER_ID ON ORDERVF (ORDER_DEALER_ID) TABLESPACE TS_ORDERS_INDEX;
CREATE INDEX IDX_ORDER_CLIENT_STATUS ON ORDERVF (ORDER_CLIENT_ID, ORDER_STATUS_ID) TABLESPACE TS_ORDERS_INDEX;
CREATE INDEX IDX_ORDER_DATE ON ORDERVF (ORDER_DATE) TABLESPACE TS_ORDERS_INDEX;
CREATE INDEX IDX_ORDER_AMOUNT ON ORDERVF (ORDER_AMOUNT) TABLESPACE TS_ORDERS_INDEX;

DROP TABLE IF EXISTS ORDER_DISH CASCADE CONSTRAINT;
CREATE TABLE ORDER_DISH (
    ...
    CONSTRAINT ORDER_DISH_ORDER_ID_FK FOREIGN KEY (ORDER_DISH_ORDER_ID) REFERENCES ORDERVF (ORDER_ID),
...
DROP TABLE IF EXISTS ORDER_REVIEW CASCADE CONSTRAINT;
CREATE TABLE ORDER_REVIEW (
    ...
    CONSTRAINT ORDER_REVIEW_ORDER_ID_FK FOREIGN KEY (ORDER_REVIEW_ORDER_ID) REFERENCES ORDERVF (ORDER_ID)
) TABLESPACE TS_ORDERS_DATA;

DROP TABLE IF EXISTS ORDER_STATUS_HISTORY CASCADE CONSTRAINT;
CREATE TABLE ORDER_STATUS_HISTORY (
    ...
    CONSTRAINT ORDER_STATUS_HISTORY_ORDER_ID_FK FOREIGN KEY (ORDER_STATUS_HISTORY_ORDER_ID) REFERENCES ORDERVF (ORDER_ID),
