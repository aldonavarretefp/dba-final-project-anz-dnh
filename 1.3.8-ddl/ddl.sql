...
DROP TABLE IF EXISTS USERVF CASCADE;
CREATE TABLE USERVF (
...
DROP TABLE IF EXISTS DEALER_BANK_DATA CASCADE;
...
DROP TABLE IF EXISTS DEALER_PAYMENT CASCADE;
...
DROP TABLE IF EXISTS PROVIDER_BANK_DATA CASCADE;
...
DROP TABLE IF EXISTS PROVIDER_GALLERY CASCADE;
...
DROP TABLE IF EXISTS PROVIDER_PAYMENT CASCADE;
